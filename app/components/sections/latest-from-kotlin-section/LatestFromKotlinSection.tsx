...
import styles from './LatestFromKotlinSection.module.scss';
    ...
    return (
        <div>
            <Section
                className={cn(
                    styles.section,
                    styles["latest-from-kotlin-section"]
                )}
            >
                <Container>
                    ...
                    <div className="kto-offset-top-32">
                        <a
                            ...
                            className={styles["latest-from-kotlin-section__banner-link"]}
                        >
                            <picture>
                            ...
                            >
                                ...
                                <h3 className={cn(textCn('rs-text-2'), 'kto-offset-top-8')}>
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className={textCn("rs-link", { mode: "rock", external: true })}
                                    >
                                        {news.title}
                                    </a>
                                </h3>
                    ...
                    <div
                        className={cn(
                            styles["latest-from-kotlin-section__button"],
                            'kto-offset-top-32'
                        )}
                    >
                        <Button
